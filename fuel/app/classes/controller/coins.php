<?php
class Controller_Coins extends Controller_Backend_Admin
{

	public function action_index()
	{
		$data['coins'] = Model_Coin::find('all');
        $this->template->content = View::forge('coins/index', $data);

	}

	public function action_view($id = null)
	{
		is_null($id) and Response::redirect('coins');
        ...
        $this->template->content = View::forge('coins/view', $data);
	}
	...
	public function action_create()
	{
		...
		$this->template->content = View::forge('coins/create');
	}
	...
	public function action_edit($id = null)
	{
		...
		else
		{
            ...
            $data['coins'] = $coin;
            $this->template->content = View::forge('coins/edit', $data);
		}
