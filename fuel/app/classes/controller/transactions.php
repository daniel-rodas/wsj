<?php
class Controller_Transactions extends \Controller_Backend_Admin
{
	...
	public function action_index()
	{
		...
		$this->template->content = View::forge('transactions/index', $data);
	}
	...
	public function action_view($id = null)
	{
        ...
        $this->template->content = View::forge('transactions/view', $data);
	...
	public function action_create()
	{
        ...
        $this->template->content = View::forge('transactions/create');
	...
	public function action_edit($id = null)
	{
		...
		else
		{
            ...
            $this->template->content = View::forge('transactions/edit', $data);
        }
