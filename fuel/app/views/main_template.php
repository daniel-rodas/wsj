...
<html ng-app="wsj" lang="en">
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <?php echo Asset::css( array('bootstrap.min.css', 'styles.css', 'animations.css') ); ?>
    ...
    <?php Asset::add_path('app/', 'ngApp'); ?>
<!--    --><?php //echo Asset::ngApp(array('app.module.js')); ?>
    <?php echo Asset::get_file('app.module.js', 'ngApp'); ?>
    <!--  JS Libs  -->
