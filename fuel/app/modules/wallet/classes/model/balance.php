...
class Model_Balance extends \Orm\Model_Soft
{
    ...
    */
       ...
       return $total_balance = \DB::query($sql)->as_object('\Wallet\Model_Balance')->execute();
    }
    ...
    public static function dailyBalance()
    {
        ...
        return $daily_balance = \DB::query($sql)->as_object('\Wallet\Model_Balance')->execute();
...
// Need to fiqure this one out with UNIX TIME
    public static function periodTimeBalance()
    {
        ...
        return $period_time_balance = \DB::query($sql)->as_object('\Wallet\Model_Balance')->execute();
...
//        DB::expr('COUNT(table_name.table_column)');
        return $customer_balance = \DB::query($sql)->as_object('\Wallet\Model_Balance')->execute();
